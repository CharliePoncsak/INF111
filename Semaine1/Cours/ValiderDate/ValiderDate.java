/***************************************
 *Exemple regroupant une partie de la th�orie du cours 01
 *en inf111
 *<p>
 *Il s'agit d'un programme qui demande une ann�e, un mois et
...
public class ValiderDate{
    ...
    ******************************************************/
    ...
    // Sert � la v�rification de l'ann�e bissextile.
    ...
    public static void  main(String[] args){
        ...
        ******************************************************/
        ...
        //sollicitation de l'ann�e
        System.out.print("Entrez une ann�e svp : ");
        annee = clavier.nextInt();

        //redemand� tant que pas valide
        while (annee <= ANNEEMIN ){
            System.out.print("Erreur : Entrez une autre ann�e svp : ");
            annee = clavier.nextInt();
        }
        ...
        ******************************************************/
        ...
        /******************************************************
        * calcul du nombre de jour maximum pour le mois entr�
        ******************************************************/
        //f�vrier
        if (mois == FEVRIER){
        ...
        ******************************************************/
        ...
        /******************************************************
        *       affichage de la date sous forme litt�rale
        ******************************************************/
